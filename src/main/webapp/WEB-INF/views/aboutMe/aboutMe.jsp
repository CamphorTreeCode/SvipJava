...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath }/js/about-us.js" type="text/javascript" charset="utf-8"></script>
...
<!--left二级下拉菜单  end-->
	...
	<div class="rightCenter">
     	 	 ...
     	 	 <section class="current">
     	 		...
     	 		<span class="weizhi">当前位置：界面管理 > 关于我们</span>
     	 	</section>
     	 	<!--当前位置结束-->
     	   </div>
	       ...
	       <div class="rightBottom">
	       		<div class="top">
				<img src="${pageContext.request.contextPath }/img/gaunyu.png" alt="" />
				<span>关于我们</span>
				</div>
				<input type="hidden" name="aboutmeimg" value="${aboutMe.aboutmeimg}">
			    <form action="./modifyAboutMe" method="post" class="Multi">
		        	<div class="food">           		
		        		...
		        		<input type="hidden" name="aboutmeimg">
					    <div class="bigbox">					    	
					    	<textarea id="item" name="aboutmecontent" placeholder="请在此填写您的品牌介绍">${aboutMe.aboutmecontent }</textarea>
					    		<p>最佳尺寸为690px*340px</p>
		        			<!--bigbox end-->
						</div>
						<div class="fuwu">
							<label class="team">团队及服务</label>
							<textarea id="items" name="aboutmeserver" placeholder="请在此介绍您的团队以及服务">${aboutMe.aboutmeserver }</textarea>
						</div>
