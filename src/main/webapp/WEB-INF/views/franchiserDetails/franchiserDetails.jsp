...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath }/js/shenqing-jiameng.js" type="text/javascript" charset="utf-8"></script>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/shenqing-jiameng.css"/>
	...
	<div class="leftsidebar_box">
		...
		<dl class="syetem_management">
			...
			<dd class="out special"><a href="${pageContext.request.contextPath }/admin/franchiseDetails/pre-add">申请加盟</a></dd>
...
<!--left二级下拉菜单  end-->
	...
	<div class="rightCenter">
     	 	 ...
     	 	 <section class="current">
     	 		...
     	 		<span class="weizhi">当前位置：界面管理 > 申请加盟</span>
     	 	</section>
     	 	<!--当前位置结束-->
     	   </div>
	       ...
	       <div class="rightBottom">
	       		<div class="top">
				<img src="${pageContext.request.contextPath }/img/bailing.png" alt="" />
				<span>申请加盟</span>
				</div>
				<input type="hidden" name="franchisedetailsimg" value="${franchiserDetails.franchisedetailsimg}">
			    <form action="" method="post" class="Multi">
		        	<div class="food">           		
		        		<div class="shangchuan">
		        			<p class="tupian">项目介绍</p>
					    ...
					    <div class="bigbox clearfix">					    	
					    	<textarea id="item" name="franchisedetailscontent"  placeholder="请在此填写您的项目介绍">${franchiserDetails.franchisedetailscontent}</textarea>
