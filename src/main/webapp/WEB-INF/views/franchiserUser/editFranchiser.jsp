...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath }/js/edit-acount.js" type="text/javascript" charset="utf-8"></script>
...
<!--left二级下拉菜单  end-->
	...
	<div class="rightCenter">
     	 	 ...
     	 	 <section class="current">
     	 		...
     	 		<span class="weizhi">当前位置：账号管理 > 修改账号</span>
     	 	</section>
     	 	<!--当前位置结束-->
     	   </div>
	
	       <div class="rightBottom">
	       	<form action="./modifyFranchiserUser?franchiseruserid=${franchiserUser.franchiseruserid}" method="post">
	       		<div class="top">
				<img src="${pageContext.request.contextPath }/img/yuangon.png" alt="" />
				<span>修改账号</span>
				</div>
				<input type="hidden" name="franchiseruserid" class= "id" value="${franchiserUser.franchiseruserid}" >
				<div class="main">
					<label>账号名称</label>
					<input type="text" name="franchiseruseraccounts" class="zhanghao" value="${franchiserUser.franchiseruseraccounts}"  placeholder="请在此设置账号名称(不能超过10个字符)"/>
				</div>
				<div class="main">
					<label>用户名</label>
					<input type="text" name="franchiseruserusername" class="username"  value="${franchiserUser.franchiseruserusername}"   placeholder="请在此设置用户名(英文或者数字，长度为10个以内)"/>
				</div>
				<div class="main">
					<label>密码</label>
					<input type="text" name="franchiseruserpassword" class="pwd"  value="${franchiserUser.franchiseruserpassword}"  placeholder="请在此设置密码(英文数字混合)"/>
				</div>
				<div class="main">
					<label>淘宝联盟PID</label>
					<input type="text" name="franchiseruserpid" class="pid"  value="${franchiserUser.franchiseruserpid}" placeholder="请填写规范淘宝联盟PID" />
				</div>
				<button class="save" type="submit">修改</button>
			</form>
				...
				<button id="btn" class="cancel se">取消</button>
	     	 	...
	     	 	<script type="text/javascript">
	     	 		...
	     	 		$(function(){
			     	 		$("#btn").click(function(){
			                    location.href="findFranchiserUserList?currentPage=${currentPage}&franchiserUserUserName=${franchiserUserUserName}";
