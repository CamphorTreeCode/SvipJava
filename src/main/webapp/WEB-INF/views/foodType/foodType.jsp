...
<html>
	<head>
		...
		<script src="js/Recipes interface.js" type="text/javascript" charset="utf-8"></script>
		<!--本页面样式-->
	...
	<body>
		<div class="container-fluid">
			...
			<div class="Popup">
				...
				<div class="aa">
					<img src="img/shezhi.png" class="phone"/>
				    <span>修改名称</span>
				</div>
				<div class="bb">
					<label>原类目名称</label>
				...
				<form action="admin/RecipesType/HtUpdate" id="edit" method="get">
				<div class="cc">
					<label>更改为</label>
					<input type="hidden" name="recipestypeid" value="${recipestypeid}">
					<input type="text" name="recipestypename" class="text" value="" placeholder="请输入更改的类目名称" />
				</div>
	...
	<div class="leftsidebar_box">
		...
		<dl class="app">
			<dt class="ddt special">食谱类目管理<img src="${pageContext.request.contextPath }/img/xiajiantou.png"></dt>
			<dd class="sencod_dd special"><a href="${pageContext.request.contextPath }/admin/RecipesType/foodTypelist">添加类目</a></dd>
		</dl>
	
		<dl class="cloudd">
			<dt class="con">商品管理<img src="img/xiajiantou.png"></dt>
		...
		<div class="right col-lg-11">					
	        ...
	        <div class="rightCenter">
     	 	 ...
     	 	 <section class="current">
     	 		...
     	 		<span class="weizhi">当前位置：食谱类目管理 > 添加食谱类目</span>
     	 	</section>
     	 	<!--当前位置结束-->
     	   </div>
        	...
        	<div class="rightBottom clearfix">
        		...
        		<div class="addTo">
        		 <form action="admin/RecipesType/HtAdd" id="add" method="post">
        			<input type="text" name="recipestypename" class="Category" value="" placeholder="在此填写您要添加的食谱类目名称" />
        		...
        		<c:forEach items="${recipeList }" var="x" varStatus="vs" > 
        		   <section class="row dynamic">
        		   <div class="col-lg-1">${vs.index+1 }</div>
        		   <div class="col-lg-10"><p>${x.recipestypename}</p></div>
        		   <div class="col-lg-1">
        		   <span class="xiu" value="${x.recipestypeid }">修改 </span>
        		   <span class="shan" value="${x.recipestypeid }"> 删除</span>
				   </div>
        		   </section>
        		</c:forEach>   
        		</div>
