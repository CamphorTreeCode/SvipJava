...
<script src="${pageContext.request.contextPath }/js/addfood.js"></script>
...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/css/addfood.css" />
		...
		<div class="row">
			...
			<div class="left col-lg-1">
				...
				<div class="leftsidebar_box">
					...
					<dl class="cloud">
						...
						<dd class="first_dd them special">
							<a
					...
					<dl class="statistics">
						<dt class="refund">
							<a href="${pageContext.request.contextPath }/admin/refund/list">退款管理</a>
						</dt>
					</dl>
					<dl class="source">
			...
			<div class="right col-lg-11">
				...
				<div class="rightCenter">
					...
					<section class="current">
						<img class="laba"
							...
							class="weizhi">当前位置：食谱管理 > 添加食谱</span>
					</section>
					<!--当前位置结束-->
				</div>
				...
				<div class="rightBottom1">
					<div class="top">
						<img src="${pageContext.request.contextPath }/img/jia (3).png" />添加食谱
					</div>
					...
					<div class="category">
						...
						<div class="select-menu">
							<div class="select-menu-div">
								<input id="No1" readonly
									value="${recipesTypedefault.recipestypename}"
									class="select-menu-input"> <img
									src="${pageContext.request.contextPath }/img/jian2.png">
							</div>

							<ul class="select-menu-ul">
								<c:forEach items="${recipesTypeList }" var="rex">
									<li value1="${rex.recipestypeid}">${rex.recipestypename}<img
										src="${pageContext.request.contextPath }/img/hui.png" />
									</li>
								</c:forEach>
							</ul>
						</div>
					...
					<div class="superbig">
						...
						<ul class="upload-ul clearfix">
							<li class="upload-pick"><img class="img"
								src="${pageContext.request.contextPath }/img/photo.png"> <input
								name="hxswiperList" type="hidden" />
								<div class="webuploader-container clearfix" id="goodsUpload0">
									<div class="webuploader-pick"></div>
									<div id="rt_rt_1cdeb3p51dou6ila4e139qlve1"
										style="position: absolute; top: 0px; left: 0px; width: 118.938px; height: 118.938px; overflow: hidden; bottom: auto; right: auto;">
						...
						<p>
							<span>食谱标题</span>
							<textarea id="stitle" placeholder="请在此处填写食谱标题"></textarea>
						</p>

						<p>
							<span>需要材料</span>
							<textarea id="sdata" placeholder="请在此处填写需要的材料"></textarea>
						</p>
					</div>
					<form action="./addRecipe" method="post">
						...
						<div class="buzhou">
							<div class="superbig steps sku_1">
								<!-- 	<ul class="upload-ul clearfix"> -->
								<script id="container" name="recipesstep" type="text/plain"></script>
								<!-- </ul>		 -->
							</div>
						</div>
						<input type="hidden" name="recipestypeid"
							value="${recipesTypedefault.recipestypeid}"> <input
							type="hidden" name="recipesimg"> <input type="hidden"
							name="recipestitle"> <input type="hidden"
							name="recipesdata"> <input type="hidden"
							name="recipestypestate">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/ued/ueditor.config.js"></script>
<!-- 编辑器源码文件 -->
<script type="text/javascript"
	src="${pageContext.request.contextPath }/ued/ueditor.all.js"></script>
<!-- 实例化编辑器 -->
<script type="text/javascript">
