     	 		...
     	 		<a href="${pageContext.request.contextPath }/login/tologin">退出登录</a>
					...
					<div class="rightCenter">
						...
						<section class="current">
							...
							<span class="weizhi">当前位置：界面管理 > 学习天地 > 修改与查看</span>
						</section>
						<!--当前位置结束-->
					</div>
					...
					<div class="rightBottom">
						<div class="top">
							<img src="img/jia3.png" />修改与查看
						</div>
                        <input type="hidden" name="studyList1" value="${imgStr }"/>
                        <input type="hidden" name="learningworldvideourl1" value="${learningWorld.learningworldvideourl }"/>
                        <input type="hidden" name="learningworldvideoimgurl1" value="${learningWorld.learningworldvideoimgurl }"/>
						<form action="admin/learningWorld/updataLearningWorld" method="post">
						    <input type="hidden" name="learningworldid" value="${learningWorld.learningworldid }">
                            ...
                            <input type="hidden" name="draftstate" value="${learningWorld.draftstate }"/>
							<div class="title">
								<span>标题</span>
								<textarea  placeholder="请在此添加动态标题"  name="learningworldtitle" >${learningWorld.learningworldtitle }</textarea>
							</div>
							<div class="article">
								<span>添加正文</span>
								<textarea  placeholder="请在此添加动态正文"  name="learningworldcontent" >${learningWorld.learningworldcontent }</textarea>
							</div>
...
<!--	<script type="text/javascript" src="js/fileUpload.js"></script>-->
	...
	<script src="js/updateStudyWorld.js"></script>
