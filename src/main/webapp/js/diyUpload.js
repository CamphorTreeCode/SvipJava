    ...
    function createBox( $fileInput, file, webUploader ) {
        ...
        var li = '<li id="fileBox_'+file_id+'" class="diyUploadHover"> \
					<div class="viewThumb">\
					    ...
					    <p class="diyControl"><span class=""><i></i></span><span class="diyCancel"><i></i></span><span class=""><i></i></span></p>\
					</div> \
				</li>';
        ...
        webUploader.makeThumb( file, function( error, dataSrc ) {
            ...
            //如果是视频截取视频第一帧
            	...
            	$fileBox.find('.viewThumb').append('<img src="img/bzcyl.jpg" >');
        	    ...
        	    //webUploader.getFiles()[0].source.source获取上传的文件
	            reader.readAsDataURL(webUploader.getFiles()[0].source.source, "UTF-8");//读取文件 
	            ...
	            reader.onloadend=function(){
	            	 (function() {  
	                	  ...
	                	  var initialize = function() {  
	                	    ...
	                	    //video.setAttribute("src","img/movie.ogg");
	                	    video.setAttribute("src",fileString);
	                	  ...
	                	  var captureImage = function() {  
	                	    ...
	                	    $fileBox.find('.viewThumb').append(img);
	                	    
	                	    //$fileBox.find('.viewThumb').append('<video src="'+fileString+'" >');
	                	  };  
	                	  $(initialize);        
	                	}());
