$(function(){
    ...
    var ZHweiyi=true;
	 $(".zhanghao").blur(function(){
		var franchiseruserid = $(".id").val();
	    var xiaoyan=$(this).val();
	    $.post("../franchiserUser/EditAccountXY",{xiaoyan:xiaoyan,franchiseruserid:franchiseruserid},function(data){
	        //账号校验判断
	        if(data=="0"){
	        	alert("您输入的账户名称重复");
	        	ZHweiyi = false;
    ...
    var YHweiyi=true;
	 $(".username").blur(function(){
		var franchiseruserid = $(".id").val();
	    var xiaoyan=$(this).val();
	    $.post("../franchiserUser/EditUserNameXY",{xiaoyan:xiaoyan,franchiseruserid:franchiseruserid},function(data){
	        //账号校验判断
	        if(data=="0"){
	        	alert("您输入的用户名重复");
	        	YHweiyi =  false;
    ...
    var PIDweiyi=true;
	 $(".pid").blur(function(){
		var franchiseruserid = $(".id").val();
	    var xiaoyan=$(this).val();
	    $.post("../franchiserUser/EditPIDXY",{xiaoyan:xiaoyan,franchiseruserid:franchiseruserid},function(data){
	        //账号校验判断
	        if(data=="0"){
	        	alert("您输入的PID重复");
	        	PIDweiyi =  false;
